...
my $test_data = {
    ...
    3 => {
        ...
        'result' => {
            'message'   => "/course/save _check_fields: didn't has required data in 'status' = ''",
            'status'    => 'fail',
        },
        'comment' => 'No status:' 
    },
    4 => {
        ...
        'result' => {
            'message'   => "/course/save _check_fields: didn't has required data in 'name' = ''",
            'status'    => 'fail',
        },
    ...
    5 => {
        ...
        'result' => {
            'message'   => "/course/save _check_fields: empty field 'attachment', didn't match regular expression",
            'status'    => 'fail',
        },
