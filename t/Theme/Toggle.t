...
my $test_data = {
    ...
    2 => {
        ...
        'result' => {
            'message'   => "/theme/toggle _check_fields: didn't has required data in 'value' = ''",
            'status'    => 'fail'
        },
        'comment' => 'No value:'
    },
    3 => {
        ...
        'result' => {
            'message'   => "/theme/toggle _check_fields: didn't has required data in 'id' = ''",
            'status'    => 'fail'
        },
        'comment' => 'No id:' 
    },
    4 => {
        ...
        'result' => {
            'message'   => "/theme/toggle _check_fields: didn't has required data in 'fieldname' = ''",
            'status'    => 'fail'
        },
    ...
    5 => {
        ...
        'result' => {
            'message'   => "Theme with '404' doesn't exist",
            'status'    => 'fail'
        },
        'comment' => 'Wrong id:' 
    },
    6 => {
        ...
        'result' => {
            'message'   => "Theme with '0' doesn't exist",
            'status'    => 'fail'
        },
        'comment' => '0 id:' 
    }
...
foreach my $test (sort {$a <=> $b} keys %{$test_data}) {
    ...
    $t->post_ok( $host.'/theme/toggle' => {token => $token} => form => $data );
    unless ( $t->status_is(200)->{tx}->{res}->{code} == 200  ) {
        diag("Can't connect \n");
        last;
    }
