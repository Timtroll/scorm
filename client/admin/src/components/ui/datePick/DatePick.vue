      ...
      <div
        ...
        <div class="vdpInnerWrap">
          <header class="vdpHeader">
            ...
            <div class="vdpPeriodControls">
              <div class="vdpPeriodControl">
                <button v-bind:class="directionClass"
          ...
          <div v-if="pickTime && currentTime"
            ...
            <span v-if="pickMinutes"
                  class="vdpTimeSeparator">:</span>
            <div v-if="pickMinutes"
                 class="vdpTimeUnit">
            ...
            <span v-if="pickSeconds"
                  class="vdpTimeSeparator">:</span>
            <div v-if="pickSeconds"
                 class="vdpTimeUnit">
