<template>
  <!--login / recover form-->
  <div
    class="uk-width-1-1 uk-width-expand@s uk-width-1-2@l uk-flex uk-flex-center uk-height-viewport  uk-flex-center uk-flex-left@l"
    :class="[status !== 'loading' ? background.default : background.loading]">
    <div class="uk-section uk-light uk-height-1-1 uk-flex uk-flex-middle uk-overflow-auto">
