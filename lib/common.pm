...
use Exporter();
use vars qw( @ISA @EXPORT @EXPORT_OK $config $clear $tokens $log $routs $vfields $permissions $websockets $beans $dbh $FieldsAsArray $Fields $DataTables $FeildsById %mime );
